...
const OrderForm = () => {
    ...
    const id = v1()
      ...
      if (setDataFetchStatus === 'pending') return <p className="text-center py-12 text-9xl w-full">Loading...</p>
    ...
    return (
        <form onSubmit={OnSubmit} className="text-gray-900 dark:text-gray-100">
            ...
            <fieldset className="mb-6">
                ...
                <div className="border rounded p-4 transition-colors duration-200
