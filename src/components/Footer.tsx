...
const Footer = () => {
  return (
    <footer className="relative bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300 
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <section className="space-y-3" aria-labelledby="about-us">
            <h3 id="about-us" className="text-xl font-bold text-gray-900 dark:text-white">
              Про нас
            </h3>
          ...
          <address className="space-y-3 not-italic">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Контакти</h3>
            <div className="space-y-1">
              <p>
                <a href="mailto:info@myshop.com" className="hover:text-cyan-600 dark:hover:text-cyan-400">
                  ✉️ info@myshop.com
                </a>
              </p>
              <p>
                <a href="tel:+380991234567" className="hover:text-cyan-600 dark:hover:text-cyan-400">
                  📞 +38 (099) 123-45-67
                </a>
              </p>
            </div>
          ...
          <section className="space-y-3" aria-labelledby="links">
            <h3 id="links" className="text-xl font-bold text-gray-900 dark:text-white">Навігація</h3>
            <nav className="space-y-2">
              <a href="/privacy" className="block hover:text-cyan-600 dark:hover:text-cyan-400">
                Політика конфіденційності
              </a>
              <a href="/terms" className="block hover:text-cyan-600 dark:hover:text-cyan-400">
                Умови використання
              </a>
            </nav>
          </section>
        ...
        {/* Social networks */}
        <nav className="pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-center gap-6">
          <a href="https://facebook.com" className="p-2 rounded-full bg-gray-100 dark:bg-gray-700 
          ...
          <a href="https://twitter.com" className="p-2 rounded-full bg-gray-100 dark:bg-gray-700 
                                                 hover:bg-cyan-100 dark:hover:bg-cyan-900/50 
                                                 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://instagram.com" className="p-2 rounded-full bg-gray-100 dark:bg-gray-700 
                                                   hover:bg-cyan-100 dark:hover:bg-cyan-900/50 
                                                   transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
